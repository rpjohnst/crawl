...
impl Rules for Syntax {
    fn walk_rules(&self, f: &mut impl VisitRules) {
        ...
        f.def("lambda-declarator")
            .alt(("lambda-specifier-seq", "exception-specification".opt(), "attribute-specifier-seq".opt(), "trailing-return-type".opt()))
            .alt(("exception-specification", "attribute-specifier-seq".opt(), "trailing-return-type".opt()))
            .alt("trailing-return-type")
            .alt(("(", "parameter-declaration-clause", ")", "lambda-specifier-seq".opt(), "exception-specification".opt(), "attribute-specifier-seq".opt(), "trailing-return-type".opt(), "requires-clause".opt()))
        ;
        ...
        f.def("parameters-and-qualifiers")
            .alt(("(", "parameter-declaration-clause", ")", "cv-qualifier-seq".opt(), "ref-qualifier".opt(), "exception-specification".opt(), "attribute-specifier-seq".opt()));
        ...
        f.def("base-specifier")
            .alt(("attribute-specifier-seq".opt(), "class-or-decltype"))
        ...
        f.def("exception-specification")
            .alt("dynamic-exception-specification")
            .alt("noexcept-specifier")
        ;

        f.def("dynamic-exception-specification")
            .alt(("throw", "(", "type-id-list".opt(), ")"))
        ;

        f.def("type-id-list")
            .alt(("type-id", "...".opt()))
            .alt(("type-id-list", ",", "type-id", "...".opt()))
        ;
    ...
    fn walk_terminals(&self, f: &mut impl VisitTerminals) {
        ...
        f
            ...
            .keyword("break").keyword("case").keyword("catch").keyword("char").keyword("char8_t")
            .keyword("char16_t").keyword("char32_t").keyword("class").keyword("concept").keyword("const")
            .keyword("consteval").keyword("constexpr").keyword("constinit").keyword("const_cast")
            .keyword("continue").keyword("co_await").keyword("co_return").keyword("co_yield")
            .keyword("decltype").keyword("default").keyword("delete").keyword("do").keyword("double")
            .keyword("dynamic_cast").keyword("else").keyword("enum").keyword("explicit").keyword("export")
            .keyword("extern").keyword("false").keyword("float").keyword("for").keyword("friend")
            .keyword("goto").keyword("if").keyword("inline").keyword("int").keyword("long").keyword("mutable")
            .keyword("namespace").keyword("new").keyword("noexcept").keyword("nullptr").keyword("operator")
            .keyword("private").keyword("protected").keyword("public").keyword("register")
            .keyword("reinterpret_cast").keyword("requires").keyword("return").keyword("short")
            .keyword("signed").keyword("sizeof").keyword("static").keyword("static_assert")
            .keyword("static_cast").keyword("struct").keyword("switch").keyword("template").keyword("this")
            .keyword("thread_local").keyword("throw").keyword("true").keyword("try").keyword("typedef")
